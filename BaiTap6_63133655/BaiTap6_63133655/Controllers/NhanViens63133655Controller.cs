...
using BaiTap6_63133655.Models;

namespace BaiTap6_63133655.Controllers
{
    public class NhanViens63133655Controller : Controller
    {
        private QLNV_63133655Entities db = new QLNV_63133655Entities();

        // GET: NhanViens63133655
        ...
        // GET: NhanViens63133655/Details/5
        ...
        // GET: NhanViens63133655/Delete/5
        ...
        // POST: NhanViens63133655/Delete/5
        ...
        [HttpGet]
        public ActionResult TimKiem(string maNV = "", string hoTen = "", string gioiTinh = "", string luongMin = "", string luongMax = "", string diaChi = "", string maPB = "")
        {
        ...
        [HttpPost]
        public ActionResult TimKiemNV(string maNV, string HoTen)
        {

            var nhanViens = db.NhanViens.SqlQuery("exec TimKiem '"+maNV+"', N'"+HoTen+"' ");
